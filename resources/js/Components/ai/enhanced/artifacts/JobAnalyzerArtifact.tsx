                ...
                <div className="flex bg-amber-100 rounded-lg p-1">
                    {['overview', 'keywords', 'recommendations'].map(mode => (
                        <button
                            ...
                            className={`px-3 py-1 rounded text-xs transition-all capitalize ${viewMode === mode
                        ...
                        {keywords.map((keyword, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`p-3 rounded-lg border-2 text-center transition-all hover:shadow-md ${keyword.inProfile

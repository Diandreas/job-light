                                ...
                                <DialogContent>
                                    ...
                                    <div className="p-4 text-center">
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            La création d'offres complètes avec candidatures intégrées sera bientôt disponible.
                                        </p>
                                        <p className="text-sm text-gray-500">
                                            En attendant, vous pouvez créer des annonces simples avec vos informations de contact.
                                        </p>
                                    </div>
                                </DialogContent>
                            </Dialog>

        ...
        try {
            ...
            const response = await fetch('/api/cinetpay/initialize', {
                ...
                body: JSON.stringify({
                    ...
                    customer_name: (window as any)?.auth?.user?.name || 'Utilisateur',
                    customer_surname: (window as any)?.auth?.user?.surname || '',
                    customer_email: (window as any)?.auth?.user?.email || '',
                    customer_phone_number: (window as any)?.auth?.user?.phone || '',

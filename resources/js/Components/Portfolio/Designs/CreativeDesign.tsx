                                                ...
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        {exp.references && exp.references.length > 0 && (
                                                            <div className="mt-3 p-3 bg-gradient-to-r from-amber-50 to-purple-50 rounded-lg">
                                                                <h4 className="text-sm font-medium text-gray-700 mb-2">Références :</h4>
                                    ...
                                    <div className="space-y-4">
                                        {cvData.languages.map((lang, index) => (
                                            <motion.div
                                                ...
                                                className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-50 to-purple-50 rounded-lg hover:from-amber-100 hover:to-purple-100 transition-all duration-300"
                                            >
